...
import { Wallet, Receipt, TreePine, Flame, Users, TrendingDown, TrendingUp } from 'lucide-react';

export default function SuperadminDuitTrackerPage() {
  const { user } = useAuth();
  const [sidebarCollapsed, setSidebarCollapsed] = useState(false);
  const { data: stats, loading, error: cacheError } = useCache<any>('superadmin:duit-tracker', () => superadminService.getDuitTrackerStats());
